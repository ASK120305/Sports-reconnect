    ...
    <header className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-6 py-4 backdrop-blur-lg shadow-glow">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm text-brand-100 transition duration-200 hover:border-brand-500/60 hover:text-white"
        >
          Dashboard
        </button>
